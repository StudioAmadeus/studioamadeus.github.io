...
Fifteen ideas in, one survivor on probation. That sounds like failure. It isn't. Most trading ideas don't work — that's just true — and the entire point of the factory is finding that out cheaply, on paper, before real money is anywhere near them. A ninety percent kill rate is what honesty looks like at scale.
